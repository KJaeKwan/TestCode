...
class UserControllerTest {
    ...
    @Test
    public void 사용자는_특정_유저의_주소를_제외한_정보를_전달_받을_수_있다() throws Exception {
        //given
        //when
        //then
    ...
    @Test
    public void 사용자는_존재하지_않는_유저의_아이디로_API_호출한_경우_404_에러를_받는다() throws Exception {
        //given
        //when
        //then
    ...
    @Test
    public void 사용자는_인증_코드가_일치하지_않을_경우_권한없음_에러를_내려준다() throws Exception {
        //given
        //when
        //then
        mockMvc.perform(get("/api/users/2/verify")
    ...
    @Test
    public void 사용자는_본인_정보를_수정할_수_있다() throws Exception {
        //given
