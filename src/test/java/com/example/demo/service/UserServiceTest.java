...
class UserServiceTest {
    ...
    @Test
    public void getById는_ACTIVE_상태인_유저를_찾아올_수_있다() throws Exception {
        //given
        //when
    ...
    @Test
    public void getById는_PENDING_상태인_유저를_찾아올_수_없다() throws Exception {
        //given
        //when
        //then
        assertThatThrownBy(() -> {
    ...
    @Test
    public void user를_로그인_시키면_마지마_로그인_시간이_변경된다() throws Exception {
        //given
        //when
        userService.login(1);
    ...
    @Test
    public void PENDING_상태의_사용자는_인증코드로_ACTIVE_시킬_수_있다() throws Exception {
        //given
        //when
    ...
    @Test
    public void PENDING_상태의_사용자는_잘못된_인증코드를_받으면_에러를_던진다() throws Exception {
        //given
        //when
        //then
        assertThatThrownBy(() -> {
